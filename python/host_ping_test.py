...
설명 : Wall 모니터링 구성할 호스트의 네트워크 연결 상태를 확인하는 프로그램
최초 작성일 : 2021. 09. 03
'''
...
def createArgumentParser():
    ...
    # 프로그램 설명
    parser = argparse.ArgumentParser(description='Wall 모니터링 구성할 호스트의 네트워크 연결 상태를 확인하는 프로그램',
                                     epilog='copyrightⓒ 2021 All rights reserved by ABLECLOUD™',
                                     usage='%(prog)s arguments')

    # 인자 추가: https://docs.python.org/ko/3/library/argparse.html#the-add-argument-method

    parser.add_argument('-hns', '--host-names', type=str, nargs='*',
                        help='input Value to three host names', required=True)
    ...
    parser.add_argument('-H', '--Human', action='store_const',
                        dest='flag_readerble', const=True, help='Human readable')
